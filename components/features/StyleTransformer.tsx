...
const STYLES: Style[] = [
  ...
  { id: "classical", label: "古文風", prompt: "平安〜江戸時代の古典的な日本語の文体" },
  {
    ...
    label: "おじさん構文",
    prompt:
      "いわゆる「おじさん構文」に変換してください。以下のルールを厳守すること。①相手をカタカナのニックネームで呼ぶ（例：「ミカチャン」「タロウクン」）②文中に古典的な絵文字を多用する（😁💓😵🍺👫❗など、ガラケー時代のもの）③古い顔文字を使う（(^^♪ f^_^; (^^)/ (-_-;) など）④昭和〜平成初期の古いスラングを混ぜる（「ナーンチャッテ」「トホホ」「ドロンします」「バイビー」「レッツラゴー」など）⑤さりげなく下心や距離を縮めようとするニュアンスを含める⑥一文が短く、改行・感嘆符・❗が多い⑦全体的に気色悪いほど馴れ馴れしい。出力はそのままLINEで送れるような文章にすること。",
  },
  {
    id: "dog",
    label: "犬向け",
